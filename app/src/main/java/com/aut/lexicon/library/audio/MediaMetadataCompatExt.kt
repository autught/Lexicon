...
inline val MediaMetadataCompat.albumArtUri: Uri?
    get() = this.getString(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI)?.toUri() ?: Uri.EMPTY
 ...
 */
const val METADATA_KEY_FLAGS = Constants.APP_ID + ".media.METADATA_KEY_FLAGS"
